...
| **Preprint** — Benoît Prieur, *From Pseudorandom Play to Auditable Esports Competition: A Layered Randomness Infrastructure for Competitive Games* (EN), 2026. [Zenodo · 10.5281/zenodo.20991595](https://doi.org/10.5281/zenodo.20991595). Backed by the auditable-randomness layers **C5/C6** implemented here (hash-chained receipts, commit-reveal journal) — see [`docs/AUDIT.md`](docs/AUDIT.md). | [`preprint-randomness`](https://github.com/thepriben/quantum-tetris/releases/tag/preprint-randomness) |
